...
- date 为传入时间 例："2023/5/10 11:32:01" 2023-02-01 09:32:01
- type 为返回类型 例：- / 年月日 年
- 默认规则，大于等于一天(24 小时)展示'X 天前；大于等于 30 天且小于 365 天展示'X 个月前'；大于等于 365 天且展示'x 年前'，否则按照传入参数规则展示 zeroFillFlag 参数为是否数字补零，默认补零
- 时间参数 date 为必写参数
